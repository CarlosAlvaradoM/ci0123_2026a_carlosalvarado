...
void* Servidor::ejecutar(void* arg){
    ...
    for(int i=0;i<NUM_CLIENTES;i++){
        ...
        // =================================================
        // COMANDO REQUEST -> devolver directorio completo
        // =================================================
        ...
        if(cmd == 'R'){
            ...
            resp.contenido =
                crearMensaje('D', directorio);
        }

        // =================================================
        // COMANDO GET -> devolver figura especifica
        // =================================================
