...
size_t Socket::Read( void * buffer, size_t size ) {
   ...
   if ( -1 == st ) {
      throw std::runtime_error( "Socket::Read( void *, size_t ) read failed" );
   }
...
size_t Socket::Write( const void * buffer, size_t size ) {
   ...
   if ( -1 == st ) {
      throw std::runtime_error( "Socket::Write( void *, size_t ) write failed" );
   }
...
size_t Socket::Write( const char * text ) {
   ...
   if ( -1 == st ) {
      throw std::runtime_error( "Socket::Write( char * ) write failed" );
   }
