...
int main() {
    ...
    // Modificar
    char nombreFiguraModificar[] = "ovejaB";

    modificarFigura(ruta, nombreFiguraModificar,
                    "3 brick 1x2 black\n"
                    "2 brick 2x4 white\n"
                    "1 brick 2x2 white\n"
                    "probando aumento de figura\n"
                    "en un campo donde no se puede aumentar\n"
                    "FINAL"
    );

    // Eliminar
    char nombreFiguraEliminar[] = "pato";

    eliminarFigura(ruta, nombreFiguraEliminar);



    // Agregar pato mas pequeno post eliminacion
    escribirStringEnBloquesLibres(ruta, "pato1",
                                  "1 brick 2x2 slope orange\n"
                                  "2 brick 2x3 yellow\n"
                                  "FINAL de agregar"
    );
    ...
    // Leer pato
    std::cout << "LEYENDO PATO1\n";
    leerFigura(ruta, "pato1");
