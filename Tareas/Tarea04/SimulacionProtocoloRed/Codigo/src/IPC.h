...
public:
    // CLiente termino solicitar
    static int clientes_listos;
    static pthread_mutex_t mutex_contador;
    static sem_t sem_todos_clientes;

    // Interceptor termino de reenviar
    static int solicitudes_enviadas;
    static pthread_mutex_t mutex_interceptor_contador;
    static sem_t sem_interceptor_termino;

    // Servidor termino de responder
    static int respuestas_generadas;
    static pthread_mutex_t mutex_servidor_contador;
    static sem_t sem_servidor_termino;
